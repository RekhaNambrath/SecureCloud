...
class FileUploadsControllerTest < ActionController::TestCase
  ...
  test "should create file_upload" do
    assert_difference('FileUpload.count') do
      post :create, file_upload: { attachment: @file_upload.attachment, fname: @file_upload.fname, ftype: @file_upload.ftype, keywords: @file_upload.keywords, owner: @file_upload.owner }
    end
  ...
  test "should update file_upload" do
    patch :update, id: @file_upload, file_upload: { attachment: @file_upload.attachment, fname: @file_upload.fname, ftype: @file_upload.ftype, keywords: @file_upload.keywords, owner: @file_upload.owner }
    assert_redirected_to file_upload_path(assigns(:file_upload))
  end
